...
#assert.eq(parameter-data.active.model_id, "ribon-rnastructure-6.6-rna")
#assert.eq(parameter-data.active.reference_archive_sha256, "8a2904c4b9e16854a2aac3c6f3e510c844685f8cf330601e986d12f7d97dadc8")
