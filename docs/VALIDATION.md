...
This checks Rust formatting, bounded library tests, Clippy, and Typst smoke/public-API compilation. Integration and reference suites, the long-sequence log-domain stress test, WASM build and ABI checks, performance measurements, exhaustive feature matrices, and image validation remain in the release gate.
