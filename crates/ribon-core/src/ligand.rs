...
fn iupac_matches(symbol: u8, base: u8) -> bool {
    match symbol {
        ...
        b'C' => base == b'C',
        b'G' => base == b'G',
        b'U' => matches!(base, b'U' | b'T'),
        b'R' => matches!(base, b'A' | b'G'),
        b'Y' => matches!(base, b'C' | b'U' | b'T'),
        b'S' => matches!(base, b'C' | b'G'),
        b'W' => matches!(base, b'A' | b'U' | b'T'),
        b'K' => matches!(base, b'G' | b'U' | b'T'),
        b'M' => matches!(base, b'A' | b'C'),
        b'B' => matches!(base, b'C' | b'G' | b'U' | b'T'),
        b'D' => matches!(base, b'A' | b'G' | b'U' | b'T'),
        b'H' => matches!(base, b'A' | b'C' | b'U' | b'T'),
        b'V' => matches!(base, b'A' | b'C' | b'G'),
        b'N' => matches!(base, b'A' | b'C' | b'G' | b'U' | b'T'),
        _ => false,
    }
}
